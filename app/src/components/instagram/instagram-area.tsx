...
export default function InstagramArea() {
  ...
  return (
    <div className="tp-instagram-area tp-instagram-ptb text-center container-fluid " style={{ paddingTop: '500px', marginBottom: '500px' }}>
      <div className="tp-instagram-thumb-wrap p-relative">
        ...
        <div className="tp-instagram-thumb">
          ...
          <Image src="/assets/img/home-02/instagram/insta-1.jpg" alt="inst-img" width={500} height={500} />
        </div>
